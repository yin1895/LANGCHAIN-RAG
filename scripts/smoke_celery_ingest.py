...
def try_direct_call():
    try:
        ...
        os.environ['DOCS_ROOT'] = os.environ.get('DOCS_ROOT', os.path.join(ROOT, 'tests', 'fixtures', 'docs_empty'))
        job_id = str(uuid.uuid4())
        print('Calling run_ingest_task directly with job_id', job_id, 'DOCS_ROOT=', os.environ['DOCS_ROOT'])
